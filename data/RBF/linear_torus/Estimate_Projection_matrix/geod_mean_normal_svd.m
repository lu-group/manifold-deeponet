function [P0_tilde] = geod_mean_normal_svd(x,k,d,indxB)
%%% Inputs
    %%% x       - N-by-[n_R] data set with N data points in R^n_R
    %%% k       - number of nearest neighbors to use
    %%% d       - intrinsic dimension of manifold
    %%% indxB   - set of points where we want to estimate the projection matrix
    
%%% Outputs
    %%% P0_tilde -  N*n*n tensor, P0_tilde(i,:,:) is the estimated
    %%% projection matrix at point x_i
