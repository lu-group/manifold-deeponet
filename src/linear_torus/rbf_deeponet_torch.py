...
from rbf_utils_ob import PDEOperatorRBFCartesianProd, KappaFuncSpace
...
def main(Numk, fn):
    ...
    dde.utils.save_loss_history(losshistory, f"{OUTPUT_DIR}/loss_rbf_ob_0_{Numk}_{fn}.dat")
    dde.utils.plot_loss_history(losshistory, f"{OUTPUT_DIR}/loss_rbf_ob_0_{Numk}_{fn}.png")
    ...
    np.savetxt(f"{OUTPUT_DIR}/pred_u_rbf_0_{Numk}_{fn}.txt", pred_u, delimiter=",")
