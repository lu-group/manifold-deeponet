...
from rbf_utils_20 import PDEOperatorRBFCartesianProd, KappaFuncSpace ##change
...
def predict_model():
    ...
    model.restore("model/model1000-200000.ckpt", verbose=1)  #20_00311, 50_00, 50_300  ##change
    return model
